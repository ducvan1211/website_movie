...
<body class="home blog halimthemes halimmovies" data-masonry="">
                ...
                <div class="col-md-5 col-sm-6 halim-search-form hidden-xs">
                    <div class="header-nav">
                        <div class="col-xs-12">
                            ...
                            <ul class="list-group" style="list-style: none" id="results"></ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="menu-menu_1-container">
                        <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                            ...
                            @foreach ($genres as $genre)
                                <li class="mega"><a title="{{ $genre->title }}"
                            ...
                            <li class="mega dropdown">
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    @for ($i = 2000; $i < 2025; $i++)
                                        <li><a title="Phim 2020" href="{{ route('year', $i) }}">Phim
                                                {{ $i }}</a></li>
                                    @endfor
    ...
    <script>
        $(document).ready(function() {
                            ...
                            if (value.title.search(expression) != -1) {
                                ...
                                results.append(
                                    `<li class="list-group-item" style="cursor:pointer">
                                        <a href="http://127.0.0.1:8000/phim/${value.slug}">
                                        <img class="img_search" src="http://127.0.0.1:8000/${value.image}">
                                            ${value.title}</a>
                                    </li>`
                                )
                            }
            ...
            $(document).click(function(e) {
                var results = e.target.closest('#results');
                if (!results) {
                    $('#results').css('display', 'none')
                }
    ...
    <script>
        ...
        $(document).ready(function() {
            $.ajax({
                url: "{{ route('ajax.movie_view_default') }}",
                method: 'GET',
                data: {
                    "view_id": '1'
                },
        ...
        $('.movie_view').click(function() {
            ...
            $.ajax({
                url: "{{ route('ajax.movie_view') }}",
                method: 'GET',
                data: {
                    view_id
                },
                success: function(data) {
                    $('#show_' + view_id).html(data);
                }
            })
        })
    </script>
